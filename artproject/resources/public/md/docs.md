...
Two middleware functions are provided by default in the `artproject.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `artproject.handler` namespace to manage the enabled middleware.
